...
class NumberField extends TextField {
  static get properties () {
    return {
      ...
      minimumIntegerDigits: { type: Number, reflect: true },
      minimumFractionDigits: { type: Number, reflect: true },
      maximumFractionDigits: { type: Number, reflect: true },
      minimumSignificantDigits: { type: Number, reflect: true },
      maximumSignificantDigits: { type: Number, reflect: true },
